        ...
        If BusinessObjectInfo.BeforeAction = False And BusinessObjectInfo.ActionSuccess = True And (BusinessObjectInfo.EventType = SAPbouiCOM.BoEventTypes.et_FORM_DATA_ADD Or BusinessObjectInfo.EventType = SAPbouiCOM.BoEventTypes.et_FORM_DATA_UPDATE) Then
            If BusinessObjectInfo.FormUID = "VT" Then
                Try
                    ...
                    Dim Mileage As String = Trim(oform.DataSources.DBDataSources.Item(0).GetValue("U_AE_Mileage", 0))
                    Dim VehicleNo As String = Trim(oform.DataSources.DBDataSources.Item(0).GetValue("U_AE_Vno", 0))
                    ...
                    orset.DoQuery("update OITM set U_AE_RKM = '" & Mileage & "' where ItemCode = '" & VehicleNo & "'")
                ...
                If pVal.Before_Action = False Then
                        ...
                        If pVal.ItemUID = "1000011" Then
                            ...
                            Try
                                ...
                                If oform.Items.Item("1000011").Specific.selected.value <> "-" Then
                                    ...
                                    oform.Items.Item("Item_42").Specific.string = Format(orset.Fields.Item("U_AE_DOB").Value, "yyyyMMdd")
                                    ...
                                    oform.Items.Item("Item_50").Specific.string = Format(orset.Fields.Item("U_AE_Exdate").Value, "yyyyMMdd")
                                    ...
                                    oform.Items.Item("Item_54").Specific.string = Format(orset.Fields.Item("U_AE_Pexdate").Value, "yyyyMMdd")
                                Else
                                    oform.Items.Item("Item_34").Specific.string = ""
                                    oform.Items.Item("Item_36").Specific.string = ""
                                    oform.Items.Item("Item_38").Specific.string = ""
                    ...
                    If pVal.EventType = SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED Then
                        If pVal.ItemUID = "1" And pVal.Action_Success = True And pVal.FormMode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                            ...
                            oform.Visible = True
                            oform.Items.Item("Item_16").Specific.String = Format(Now.Date, "yyyyMMdd") 'Now.Date ' Format(Now.Date, "dd MMM yyyy")
                            oform.Items.Item("1000001").Enabled = False
...
"group by T1.cardcode , ISNULL(T2.Street,'') +  ', ' + ISNULL(T2.Block,'') + char(13) + ISNULL(T2.City,'') + ', ' + ISNULL(T2.StreetNo,'') + CHAR(13) + isnull(T3.[Name], '') + ' ' + isnull(T2.ZipCode,'') ")
            ...
            If pVal.FormUID = "VT" Then
                ...
                If pVal.Before_Action = False Then
                    ...
                    If pVal.ItemUID = "Item_5" And pVal.EventType = SAPbouiCOM.BoEventTypes.et_KEY_DOWN Then
                        Dim oForm As SAPbouiCOM.Form = Oapplication_TA.Forms.ActiveForm
                        Dim sString As String = oForm.Items.Item("Item_5").Specific.string

                        If pVal.CharPressed <> "8" And pVal.CharPressed <> "36" And pVal.CharPressed <> "9" Then
                            If Not IsNumeric(sString) Then
                                oForm.Items.Item("Item_5").Specific.string = "" 'Left(sString, sString.ToString.Length - 1)
                                Oapplication_TA.StatusBar.SetText("Characters are not allowed ...... !", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
                                BubbleEvent = False
                                Exit Sub
                            End If
                        End If
                ...
                If pVal.Before_Action = True Then
                    ...
                    If pVal.EventType = SAPbouiCOM.BoEventTypes.et_VALIDATE And pVal.InnerEvent = False Then
                        ...
                        If pVal.ItemUID = "Item_5" Then
                            Try
                                Dim oform As SAPbouiCOM.Form = Oapplication_TA.Forms.ActiveForm
                                If Not IsNumeric(oform.Items.Item("Item_5").Specific.String) Then
                    ...
                    If pVal.EventType = SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED Then
                        ...
                        If pVal.ItemUID = "Item_9" Or pVal.ItemUID = "Item_10" Or pVal.ItemUID = "Item_11" Or pVal.ItemUID = "Item_12" Or _
                            ...
                            Try
                                ...
                                oForm.Items.Item("35").Specific.String = Format(Now.Date, "yyyyMMdd")
                                oForm.Items.Item("Item_18").Specific.String = Format(Now.Date, "yyyyMMdd")
    ...
    Private Sub Oapplication_TA_MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean) Handles Oapplication_TA.MenuEvent
        Try
            ...
            If pVal.MenuUID = "TPOR" And pVal.BeforeAction = True Then
                ...
                oform.Items.Item("10").Specific.String = Format(Now.Date, "yyyyMMdd")
                oform.Items.Item("4").Specific.String = Format(Now.Date, "yyyyMMdd")
