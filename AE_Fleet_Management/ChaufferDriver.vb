...
"T0.[U_AE_CDate] , T0.[U_AE_Order] , T0.[U_AE_Statu] "
                    ...
                    If pVal.EventType = SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED Then
                        ...
                        If pVal.ItemUID = "1" And pVal.FormMode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                            If pVal.Action_Success = True Then
                                ...
                                oform.Items.Item("40").Specific.String = Now.Date
                ...
                Try
                    ...
                    Select Case oform.UniqueID
                        ...
                        Case "CDPL"
                            ...
                            Dim oMatrix As SAPbouiCOM.Matrix = oform.Items.Item("Item_6").Specific
                            Dim ocombo As SAPbouiCOM.ComboBox
                            oform.Items.Item("Item_5").Specific.String = Now.Date
                            Dim orset As SAPbobsCOM.Recordset = oCompany_TB_CD.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                        ...
                        Case "SM"
                            ...
                            oform.Items.Item("Item_9").Specific.String = Now.Date
                            oform.PaneLevel = 1
                ...
                If oMAtrix.Columns.Item("Date").Cells.Item(mjs).Specific.String <> "" Then
                    ...
                    If Trim(oform.Items.Item("Item_16").Specific.value) = "Open" Then
                        ...
                        If oMAtrix.Columns.Item("Col_3").Cells.Item(mjs).Specific.value = "." Then
                            oMAtrix.Columns.Item("Col_3").Cells.Item(mjs).Specific.active = True
                            Oapplication_CD.StatusBar.SetText("Guest Name Should not be Empty .......... !", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
                            Return False
                        End If
                        ...
                        If oMAtrix.Columns.Item("Col_7").Cells.Item(mjs).Specific.value = "." Then
                            ...
                            Oapplication_CD.StatusBar.SetText("Pickup Location Should not be Empty .......... !", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
                            Return False
                        End If
                        ...
                        If oMAtrix.Columns.Item("Col_8").Cells.Item(mjs).Specific.value = "." Then
                            ...
                            Oapplication_CD.StatusBar.SetText("Drop Location Should not be Empty .......... !", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
                            Return False
                        End If

                        If oMAtrix.Columns.Item("Col_9").Cells.Item(mjs).Specific.value = "" Then
                            oMAtrix.Columns.Item("Col_9").Cells.Item(mjs).Specific.active = True
                            Oapplication_CD.StatusBar.SetText("Drop Time Should be Empty .......... !", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
                            Return False
                        End If
                    End If
    ...
    Private Function Chauffer_Driver_binding(ByRef oform As SAPbouiCOM.Form) As Boolean
        ...
        Try
            ...
            ocombo.Select("Open")
            'oform.Items.Item("Item_19").Specific.String = Format(Now.Date, "dd MMM yyyy") 'Format(Now.Date, "dd MMM yyyy,ddd")
    ...
    Private Function Chauffer_Driver_binding_AddMode(ByRef oform As SAPbouiCOM.Form) As Boolean
        ...
        Try
            ...
            oform.Items.Item("Item_19").Specific.String = Now.Date 'Format(Now.Date, "dd MMM yyyy, ddd")
            Dim oMatrix As SAPbouiCOM.Matrix = oform.Items.Item("Item_17").Specific
            oMatrix.AddRow()
            oMatrix.Columns.Item("#").Cells.Item(1).Specific.string = "1"
            ocombo = oMatrix.Columns.Item("Col_0").Cells.Item(1).Specific
    ...
    Private Function Driver_assign_Binding(ByRef oform As SAPbouiCOM.Form) As Boolean
        ...
        Try
            ...
            oform.Items.Item("Item_11").Specific.String = Now.Date
            Dim orset As SAPbobsCOM.Recordset = oCompany_TB_CD.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            orset.DoQuery("SELECT *  FROM [dbo].[@AE_VTYPE]  T0")
    ...
    Private Function CB_Navigation(ByRef oForm As SAPbouiCOM.Form) As Boolean
        Try
            Dim oMAtrix As SAPbouiCOM.Matrix = oForm.Items.Item("Item_17").Specific
            oForm.Freeze(True)
            oForm.Items.Item("1000003").Enabled = False
            If Trim(oForm.Items.Item("Item_16").Specific.value) = "Open" Then
                ...
                For mjs As Integer = 1 To oMAtrix.RowCount
                    If oMAtrix.Columns.Item("Col_13").Cells.Item(mjs).Specific.value <> "" Then
                        ...
                        ''If oMAtrix.Columns.Item("Col_1").Cells.Item(mjs).Specific.value <> "One Way" Then
                        ''    ' oMAtrix.CommonSetting.SetCellEditable(mjs, 11, True)
                        ''    oMAtrix.CommonSetting.SetCellEditable(mjs, 13, False)
                        ''    oMAtrix.CommonSetting.SetCellEditable(mjs, 14, False)
                        ''ElseIf oMAtrix.Columns.Item("Col_1").Cells.Item(mjs).Specific.value = "One Way" Then
                        ''    oMAtrix.CommonSetting.SetCellEditable(mjs, 13, False)
    ...
    Private Sub Oapplication_CD_RightClickEvent(ByRef eventInfo As SAPbouiCOM.ContextMenuInfo, ByRef BubbleEvent As Boolean) Handles Oapplication_CD.RightClickEvent
        Try
            Dim oform As SAPbouiCOM.Form = Oapplication_CD.Forms.ActiveForm
