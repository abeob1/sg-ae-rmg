    ...
    Private Sub Oapplication_SM_ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean) Handles Oapplication_SM.ItemEvent
                ...
                If pVal.EventType = SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED Then
                    If pVal.ItemUID = "1" And pVal.FormMode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                        ...
                        If pVal.Action_Success = True Then
                            ...
                            oform.Items.Item("Item_9").Specific.String = Now.Date 'Format(Now.Date, "dd MMM yyyy")
                    ...
                    If pVal.ItemUID = "19" And pVal.FormMode <> SAPbouiCOM.BoFormMode.fm_FIND_MODE Then
                        Try
                            ...
                            If FileName <> "" Then
                                ...
                                oMatrix.Columns.Item("V_0").Cells.Item(oMatrix.RowCount).Specific.string = Format(Now.Date, "dd/MM/yyyy")
        ...
        If pVal.FormUID = "VSH" Then
                    ...
                    Try
                        If oCFLEvento.BeforeAction = False Then
                            ...
                            If pVal.ItemUID = "16" Then
                                ...
                                ' MsgBox(oDataTable.GetValue("U_AE_REG_DATE", 0) & " " & Format(oDataTable.GetValue("U_AE_REG_DATE", 0), "dd/MM/yyyy"))
                                oForm.Items.Item("9").Specific.string = Format(oDataTable.GetValue("U_AE_REG_DATE", 0), "dd/MM/yyyy")
            ...
            ElseIf pVal.Before_Action = True Then
                ...
                "T1.[U_AE_Odate] as 'OUT Date', T1.[U_AE_Stype] as 'Service Type', T1.[U_AE_Desc] as 'Description', T1.[U_AE_RC] as 'Repair Cost', T1.[U_AE_Sname] as 'Supplier Name', " & _
                        ...
                        Try
                            ...
                            If oform.Items.Item("Item_20").Specific.String <> "" Then
                                If oform.Items.Item("Item_18").Specific.String <> "" Then
                                    ...
                                    oform.Items.Item("Item_22").Specific.String = Format(oDate.AddDays(CInt(oform.Items.Item("Item_20").Specific.String)), "dd/MM/yyyy")
                                End If
                            End If
                        Catch ex As Exception
                        End Try
                        ...
                        Try
                            ...
                            If oform.Items.Item("Item_28").Specific.String <> "" Then
                                If oform.Items.Item("Item_26").Specific.String <> "" Then
                                    ...
                                    oform.Items.Item("Item_30").Specific.String = Format(oDate.AddDays(CInt(oform.Items.Item("Item_28").Specific.String)), "dd/MM/yyyy")
                                End If
                            End If
                        Catch ex As Exception
                        End Try
    ...
    Private Sub Oapplication_SM_MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean) Handles Oapplication_SM.MenuEvent
        Try
            ...
            If pVal.MenuUID = "SMS" And pVal.BeforeAction = True Then
                ...
                oform.Items.Item("Item_4").Specific.String = Now.Date ' Format(Now.Date, "dd MMM yyyy")
                oform.PaneLevel = 7
            ...
            If pVal.MenuUID = "VSH" And pVal.BeforeAction = True Then
                ...
                oform.Visible = True
                oform.Items.Item("12").Specific.String = Now.Date ' Format(Now.Date, "dd MMM yyyy")
