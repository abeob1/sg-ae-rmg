...
Module FleetManagement
    ...
    Public FormType_Item As Integer
    ...
    Public sOC_GLACC As Integer
    Public sMR_GLACC As Integer
    Public sPet_GLACC As Integer
    ...
    Public p_bSDBooking As Boolean = False
    ...
    Public Sub LoadFromXML(ByVal FileName As String, ByVal Sbo_application As SAPbouiCOM.Application)
        Try
            ...
            oXmlDoc.Load(sPath & "\AE_FleetMangement_Test\" & FileName)
    ...
    Public Function UDO_ADD_DuplicateRA(ByRef oform As SAPbouiCOM.Form, ByRef oCompany As SAPbobsCOM.Company, ByRef oApplication As SAPbouiCOM.Application) As Boolean
        ...
        Try
            ...
            If opt.Selected = True Then
                ...
                'DateTime.ParseExact(sPostingDate, "yyyyMMdd", Nothing) 
                ' dDate = oform.Items.Item("209").Specific.value
                If Not String.IsNullOrEmpty(oform.Items.Item("209").Specific.value) Then
                    oGeneralData.SetProperty("U_AE_NXDT", DateTime.ParseExact(oform.Items.Item("209").Specific.value, "yyyyMMdd", Nothing))
                End If
            Else
            ...
            If Not String.IsNullOrEmpty(oform.Items.Item("203").Specific.value) Then
                oGeneralData.SetProperty("U_AE_Sdate", DateTime.ParseExact(oform.Items.Item("203").Specific.value, "yyyyMMdd", Nothing))
            End If

            If Not String.IsNullOrEmpty(oform.Items.Item("205").Specific.value) Then
                oGeneralData.SetProperty("U_AE_Edate", DateTime.ParseExact(oform.Items.Item("205").Specific.value, "yyyyMMdd", Nothing))
            End If
            ...
            If Not String.IsNullOrEmpty(oform.Items.Item("Item_42").Specific.value) Then
                oGeneralData.SetProperty("U_AE_DOB", DateTime.ParseExact(oform.Items.Item("Item_42").Specific.value, "yyyyMMdd", Nothing))
            End If
            ...
            If Not String.IsNullOrEmpty(oform.Items.Item("Item_50").Specific.value) Then
                oGeneralData.SetProperty("U_AE_Exdate", DateTime.ParseExact(oform.Items.Item("Item_50").Specific.value, "yyyyMMdd", Nothing))
            End If
            ...
            If Not String.IsNullOrEmpty(oform.Items.Item("Item_54").Specific.value) Then
                oGeneralData.SetProperty("U_AE_Pexdate", DateTime.ParseExact(oform.Items.Item("Item_54").Specific.value, "yyyyMMdd", Nothing))
            End If
            ...
            If Not String.IsNullOrEmpty(oform.Items.Item("Item_68").Specific.value) Then
                oGeneralData.SetProperty("U_AE_DOB1", DateTime.ParseExact(oform.Items.Item("Item_68").Specific.value, "yyyyMMdd", Nothing))
            End If
            ...
            If Not String.IsNullOrEmpty(oform.Items.Item("Item_76").Specific.value) Then
                oGeneralData.SetProperty("U_AE_Exdate1", DateTime.ParseExact(oform.Items.Item("Item_76").Specific.value, "yyyyMMdd", Nothing))
            End If
            ...
            If Not String.IsNullOrEmpty(oform.Items.Item("Item_80").Specific.value) Then
                oGeneralData.SetProperty("U_AE_Pexdate1", DateTime.ParseExact(oform.Items.Item("Item_80").Specific.value, "yyyyMMdd", Nothing))
            End If
            ...
            If Not String.IsNullOrEmpty(oform.Items.Item("Item_97").Specific.value) Then
                oGeneralData.SetProperty("U_AE_Vdatein", DateTime.ParseExact(oform.Items.Item("Item_97").Specific.value, "yyyyMMdd", Nothing))
            End If
            ...
            If Not String.IsNullOrEmpty(oform.Items.Item("Item_100").Specific.value) Then
                oGeneralData.SetProperty("U_AE_Vdatetout", DateTime.ParseExact(oform.Items.Item("Item_100").Specific.value, "yyyyMMdd", Nothing))
            End If
