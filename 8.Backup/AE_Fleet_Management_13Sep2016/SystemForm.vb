            ...
            If pVal.FormTypeEx = "9999" Then
                If pVal.Before_Action = False And pVal.Action_Success = True Then
                    If pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_CLOSE Then
                        Try
                            Dim oForm As SAPbouiCOM.Form = Oapplication_SF.Forms.GetForm("9999", pVal.FormTypeCount)
                            Select Case oForm.Title
                                Case "List of AE_Chaffuer Booking"
                                    Dim oFormInherits As SAPbouiCOM.Form = Oapplication_SF.Forms.Item("CDB")
                                    oFormInherits.Items.Item("48").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                                    oFormInherits.Items.Item("Item_13").Enabled = False
                                    CB_Navigation(oFormInherits)
                                Case "List of AE_Self Booking"
                                    Dim oFormInherits As SAPbouiCOM.Form = Oapplication_SF.Forms.Item("SDB")
                                    NavigationValidation_SelfDriver(oFormInherits, Ocompany_SF, Oapplication_SF)
                            End Select
                        Catch ex As Exception
                            Oapplication_SF.SetStatusBarMessage(ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, False)
                            BubbleEvent = False
                            Exit Sub
                        End Try
                    End If
                ...
                If pVal.Before_Action = True Then
                    ...
                    If pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_LOAD Then
                        ...
                        Try
                            ...
                            FormType_Item = 0
                            FormType_Item = pVal.FormTypeCount
        ...
        If pVal.MenuUID = "1282" Or pVal.MenuUID = "1288" Or pVal.MenuUID = "1289" Or pVal.MenuUID = "1290" Or pVal.MenuUID = "1291" Then
            ...
            If pVal.BeforeAction = False Then
                If oform.TypeEx = "134" Then
                    ...
                    oform.Items.Item("B0003").Enabled = False
                End If
                If oform.TypeEx = "150" Then
                    Try
                        oform.Freeze(True)
                        oform = Oapplication_SF.Forms.GetFormByTypeAndCount(150, FormType_Item)
